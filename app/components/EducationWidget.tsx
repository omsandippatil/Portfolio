...
export default function EducationWidget({ darkMode = false }: EducationWidgetProps) {
  ...
  return (
    ...
    `}>
      ...
      >
        ...
        <div className="relative z-10 flex items-center mb-4">
          <div className={`p-2 rounded-xl backdrop-blur-sm mr-3 ${
            ...
            <GraduationCap size={18} className={`${darkMode ? 'text-white' : 'text-black'}`} />
          </div>
          <h3 className="font-mono text-lg font-bold tracking-tight">Education</h3>
        </div>
            ...
            {education && education.length > 0 ? (
              education.map((edu, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-3 h-3 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 mt-1 flex-shrink-0 shadow-lg" />
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  <GraduationCap size={32} className={`mx-auto mb-2 ${darkMode ? 'text-white/30' : 'text-black/30'}`} />
      ...
      <div className={`absolute inset-0 rounded-2xl sm:rounded-3xl opacity-50 blur-xl transition-opacity duration-500 ${
        darkMode 
